...
export const TEST_IDS = {
  ...
  REPORTS: {
    ...
    EMPTY_STATE: 'reports-emptyState',
    TIME_FILTER: 'reports-filter-time',
    ...
    PERSON_BUDGET: (id: string) => `reports-budget-person-${id}`,
